        ...
        <section>
            <div class="con">
                <div class="services-grid">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal1" class="service">
                        S1: <br> {{__('services.CSO Directories')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal2" class="service">
                        S2: <br>
                        {{__('services.Experts Directory')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal3" class="service">
                        S3: <br>
                        {{__('services.Human Resource directory')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal4" class="service">
                        S4: <br>
                        {{__('services.Financial Management Support')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal5" class="service">
                        S5: <br>
                        {{__('services.Legal Advisory & support')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal6" class="service">
                        S6: <br>
                        {{__('services.The CSO Information and Data Centre (physical/online)')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal7" class="service">
                        S7: <br>
                        {{__('services.Continuous Capacity Building')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal8" class="service">
                        S8: <br>
                        {{__('services.ICT4D and Biz Incubation Hub')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal9" class="service">
                        S9: <br>
                        {{__('services.Small Grant Scheme')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal10" class="service">
                        S10: <br>
                        {{__('services.Meals')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal11" class="service">
                        S11: <br>
                        {{__('services.CSO Media Centre')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal12" class="service">
                        S12: <br>
                        {{__('services.CSO Annual Conference')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal13" class="service">
                        S13: <br>
                        {{__('services.Strategic networking & twining')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal14" class="service">
                        S14: <br>
                        {{__('services.Advocacy and lobby for Donor Process streamlining')}}
                    </a>
                    <a href="#" data-bs-toggle="modal" data-bs-target="#serviceModal15" class="service">
                        S15: <br>
            ...
            <div class="modal fade" id="serviceModal10" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
            ...
            <div class="modal fade" id="serviceModal11" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
            ...
            <div class="modal fade" id="serviceModal12" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
            ...
            <div class="modal fade" id="serviceModal13" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
            ...
            <div class="modal fade" id="serviceModal14" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
            ...
            <div class="modal fade" id="serviceModal15" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
